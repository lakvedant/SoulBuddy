...
const BreathingExercise = () => {
  ...
  useEffect(() => {
    ...
    const animate = (timestamp: number) => {
      ...
      if (progress > CYCLE_DURATION) {
        ...
        setAction(animationDirection === 'in' ? 'Breathe In' : 'Breathe Out')
      }
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-b from-blue-900 to-black p-4">
      ...
      {/* Breathing disc */}
      <div 
        className="w-64 h-64 rounded-full bg-gradient-to-br from-blue-400 to-purple-500 transition-all duration-75 flex items-center justify-center"
        style={{
          transform: `scale(${scale})`,
          boxShadow: '0 0 40px rgba(66, 153, 225, 0.6)'
        }}
      >
        <div className="w-48 h-48 rounded-full bg-gradient-to-br from-blue-300 to-purple-400 opacity-80" />
      </div>
